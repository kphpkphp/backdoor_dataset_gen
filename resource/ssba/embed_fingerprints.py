...
#store_true选项的意思：sotre_true就是default=False，但是，如果sh命令行中出现具有action属性的参数时激活，也即可以在命令行中切换参数的true/false值，
#如果命令行指定了use_celeba_preprocessing，那么此时args.use_celeba_preprocessing就是true
