...
class NormalCase:
    ...
    def set_args(self, parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
        ...
        #parser.add_argument("--yaml_path", type=str, default="../config/attack/prototype/mnist.yaml")
        #parser.add_argument("--yaml_path", type=str, default="../config/attack/prototype/gtsrb.yaml")
        return parser
